...
config :contador, ContadorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "MKIlBYhVeo9gUDo71S/oG1kfvl/J1z1Ap9hIZGoOeT5D9nWkixKOurj61zJnjpue",
  watchers: [
...
config :contador, ContadorWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/contador_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
